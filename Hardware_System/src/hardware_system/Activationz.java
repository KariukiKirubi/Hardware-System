 ...
 * @author DERRICK
 */
public class Activationz extends javax.swing.JFrame {
    int pX, pY;
    ...
    private void magic()
    {
       ...
       try{
            ...
            int p = JOptionPane.showConfirmDialog(null, "Do you want to launch the software now?", "Activation successful!", JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE, icon);
             ...
             {
                String gett ="SELECT * FROM `log`";
                pst = conn.prepareStatement(gett);
                rs = pst.executeQuery();
                if(!rs.next())
                {
                    admin_log i = new admin_log();
                    i.setVisible(true);
                    this.dispose();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 170, 230, -1));

        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/attatchments/close_16.png"))); // NOI18N
        jLabel13.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jLabel13MouseClicked(evt);
            }
        });
        getContentPane().add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 200, -1, 20));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       }else if(on.equals("DPH2V") && tw.equals("TTNVB")&& thr.equals("4X9Q3")&&fo.equals("TJR4H")&&fve.equals("KHJW4"))
       {
           ...
           JOptionPane.showMessageDialog( null, "You must type the code correctly. \nIf key doesnt work contact Shazka Systems - 0714950155 ","Error! Wrong Code", JOptionPane.ERROR_MESSAGE);
       }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Activationz.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Activationz().setVisible(true);
