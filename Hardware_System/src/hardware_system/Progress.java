...
public class Progress extends javax.swing.JFrame {
 ...
 private ActionListener al;
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(893, 99, 121, -1));

        jProgressBar1.setStringPainted(true);
        getContentPane().add(jProgressBar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 80, 350, -1));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/details/globe.gif"))); // NOI18N
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 54, 60));

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/details/globe.gif"))); // NOI18N
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 1, 50, 61));

        load1.setFont(new java.awt.Font("Texas LED", 0, 24)); // NOI18N
        load1.setText("Loading . . . ");
        getContentPane().add(load1, new org.netbeans.lib.awtextra.AbsoluteConstraints(96, 53, -1, 20));

        load2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/details/Loading-Animated-GIF.gif"))); // NOI18N
        getContentPane().add(load2, new org.netbeans.lib.awtextra.AbsoluteConstraints(96, 17, 170, -1));
